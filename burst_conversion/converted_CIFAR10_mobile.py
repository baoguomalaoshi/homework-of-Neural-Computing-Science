...
parser.add_argument('--model_name', default='MobileNetV2', type=str, help='model name. vgg16 or resnet20')
parser.add_argument('--merge', default=False, type=bool, help='merge conv and bn')
...
if __name__ == '__main__':
    ...
    if args.model_name == 'MobileNetV2':
        ...
        net.load_state_dict(torch.load("./CIFAR10_MobileNet.pth", map_location=device))
