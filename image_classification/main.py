...
import sys
sys.path.append('/home/gaoxingyu/Project/Brain-Cog/')
...
parser.add_argument('--output', default='/data2/gaoxingyu/BrainCog', type=str, metavar='PATH',
...
def train_epoch(
    ...
    _logger.info(f"dataset size:{iters_per_epoch}")
    for batch_idx, (inputs, target) in enumerate(loader):
        # _logger.info(f"epoch:{epoch} b_idx:{batch_idx}")
